    ...
    <div className="fixed bottom-8 left-8 z-[99]" data-aos="fade-up">
      {isVisible && (
        ...
        >
          ...
          <span className="hidden absolute  left-full ml-4 top-1/2 transform -translate-y-1/2 opacity-0 lg:opacity-100 bg-orangeMain text-white text-[13px] px-4 py-2 rounded-lg shadow-lg transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:ml-6 whitespace-nowrap">
