...
function NewBanner() {
  return (
    <div className="bg-green-300   flex flex-col lg:flex-row justify-between items-center gap-4 shadow-lg rounded-md p-5 px-10  ">
      ...
      <div className="py-5 lg:w-[600px]">
        ...
        <p className="text-[13px] mt-3 overflow-hidden dark:text-white">
